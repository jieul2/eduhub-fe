      ...
      <TableBody>
        {payments.map((payment, index) => {
          ...
          return (
            ...
            >
              <Td className="font-medium text-ink group-hover:text-primary transition-colors max-w-32 truncate">
              ...
              <Td className="text-muted text-xs hidden md:table-cell whitespace-nowrap">
