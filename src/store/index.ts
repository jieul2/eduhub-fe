...
import { createPaymentSlice, PaymentSlice } from "../features/payment/paymentSlice";
import { createCalendarSlice, CalendarSlice } from "../features/calendar/calendarSlice";

// 2. 모든 슬라이스 타입을 합친 전체 스토어 타입 정의
// 다른 슬라이스가 추가될경우 여기에 인터렉션(&)으로 추가하면 됩니다.
// 예시: type TotalStore = StudentSlice & TeacherSlice & CourseSlice;
type TotalStore = StudentSlice & PaymentSlice & CalendarSlice;
